...
const CourseDetails = () => {
  ...
  return courseData ? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left"
      ...
      bg-gradient-to-b from-cyan-100 via-cyan-50 to-white"
        ></div>
      ...
      text-course-details-heading-small font-semibold
      text-gray-800"
          >
        ...
        <div
          ...
          md:rounded-none overflow-hidden bg-white min-w-[300px]
          sm:min-w-[420px]"
        >

        {
        playerData ? 
        <YouTube vedioId={playerData.videoId} opts={{playerVars: 
        {autoplay: 1}}} iframeClassName='w-full aspect-vedio'/>
         :
        <img src={courseData.courseThumbnail} alt="" />
          ...
          <div className="p-5">
            ...
            <div className="pt-6">
              <p
                className="md:text-xl text-lg font-medium text-gray-800
                "
              >
