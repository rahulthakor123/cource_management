...
const Navbar = () => {
  ...
  const {navigate,isEduactor} = useContext(AppContext)
  ...
  return (
    ...
    lg:px-36 border-b border-gray-500 py-4 ${isCourseListPage ? 'big-white' :
      'bg-cyan-100/70' }`}> 
      ...
      text-gray-500'>
         ...
         { user &&
         <>     
         <button onClick={()=> {navigate('/educator')}}>{isEduactor ? 'Educator Dashboard' : 'Becoome Educator'}
         </button>
